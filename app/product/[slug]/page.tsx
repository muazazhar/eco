...
async function getAlsoPurchased() {
...
export default function ProductDetails({
  ...
  const data = use(getProduct(slug));
  const products = use(getAlsoPurchased());
  console.warn("ProductDetails", data);
  // const data = { name: "sad", price: 23 };
  return (
